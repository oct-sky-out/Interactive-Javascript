...
const deleteTodo = function (event) {
  ...
  const cleanTodos = todoTexts.filter(todo => {
    // todo는 todoTexts배열의 todoObj객체항목 하나를 뜻함.
...
const loadTodos = function () {
  ...
  if (todos !== null) {
    ...
    parseTodo.forEach(todo => {
      // forEach는 parseTodo == TodoTexts와 같은 형이므로(배열) 사용 가능
